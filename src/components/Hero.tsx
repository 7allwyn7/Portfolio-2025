  ...
  return (
    <section className="bg-light-bg2 dark:bg-dark-bg2 py-20 text-center">
      <div className="container mx-auto px-4">
        ...
        <p className="text-black dark:text-white text-lg mb-6">A passionate developer who loves building solid backend systems and making cool things for the web</p>
